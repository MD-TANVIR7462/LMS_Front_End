...
export default function AdminDashboard() {
  ...
  const stats = [
    ...
    {
      title: 'Total Modules',
      value: courses.reduce((acc, course) => acc + course.modules.length, 0),
      icon: Users,
    ...
    },
    {
      ...
      value: courses.reduce((acc, course) => 
        acc + course.modules.reduce((modAcc, module) => modAcc + module.lectures.length, 0), 0
      ),
      icon: PlayCircle,
    ...
    {
      title: 'Total Revenue',
      value: `$${courses.reduce((acc, course) => acc + course.price, 0).toFixed(2)}`,
      icon: TrendingUp,
